...
# 20 "source/LCD/LCD.c" 2
# 1 "source/LCD/LCD.h" 1
# 35 "source/LCD/LCD.h"
typedef struct {
...
# 21 "source/LCD/LCD.c" 2
# 1 "source/LCD/LCD_prv.h" 1
# 33 "source/LCD/LCD_prv.h"
static void LCD_Out ( char a );
# 22 "source/LCD/LCD.c" 2
...
void LCD_Init ( LCD display ) {
    ...
    LCD_Write(0x03);
    _delay((unsigned long)((16)*(4000000UL/4000.0)));
    LCD_Write(0x03);
    ...
    LCD_Write( (0x28 & 0xF0) >> 4 ); LCD_Write( 0x28 & 0x0F);;


    LCD_Write( (0x06 & 0xF0) >> 4 ); LCD_Write( 0x06 & 0x0F);;


    LCD_Write( (0x0C & 0xF0) >> 4 ); LCD_Write( 0x0C & 0x0F);;
}
